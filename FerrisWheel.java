...
public class FerrisWheel implements DrawingObject {
    ...
    public FerrisWheel(int xPosition, int yPosition, Person player) {
        ...
        radius = 180;
        this.player = player;
        sound = new Sound("assets/carnival.wav");
    }

    /**
     * Draws the Ferris wheel using the provided Graphics2D object.
     * This method sets up the coordinates for the Ferris wheel and uses
     * transformations
    ...
    public void draw(Graphics2D g2d) {
        ...
        Line supportBelow1 = new Line(xPosition + radius, yPosition + 200, xPosition + radius - 100, yPosition + 450,
                10, Color.ORANGE);
        Line supportBelow2 = new Line(xPosition + radius, yPosition + 200, xPosition + radius + 100, yPosition + 450,
                10, Color.ORANGE);
     ...
     * This method adjusts the rotation angle to create a spinning animation and
     * controls the looping of the carnival sound based on the player's position.
     */
    @Override
    public void update() {
        rotationAngle += 1;
